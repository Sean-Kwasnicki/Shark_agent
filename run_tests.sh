...
set -e
for t in test_core test_learning test_economics test_collector test_intelligence test_hardening test_feed test_opportunity test_outreach; do
  echo "== $t =="
